...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<DXApplication_XPLiteObjectWindowsFormsApplication>();
        builder.Modules
            .Add<DXApplication_XPLiteObject.Module.DXApplication_XPLiteObjectModule>()
            .Add<DXApplication_XPLiteObjectWinModule>();
